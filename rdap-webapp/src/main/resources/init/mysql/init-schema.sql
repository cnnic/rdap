...
DROP DATABASE IF EXISTS `rdap-test`;
CREATE DATABASE `rdap-test` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `rdap-test`;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='arpa domain status';
